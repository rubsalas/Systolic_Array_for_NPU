...
add wave -radix signed /tb_system_top_8x8/memA
add wave -radix signed /tb_system_top_8x8/memB
add wave -radix signed /tb_system_top_8x8/a_mat
add wave -radix signed /tb_system_top_8x8/b_mat
add wave -radix signed /tb_system_top_8x8/c_mat
add wave -radix signed /tb_system_top_8x8/memC
add wave -radix signed /tb_system_top_8x8/pe_mult_count
add wave -radix signed /tb_system_top_8x8/pe_sum_count
add wave -radix signed /tb_system_top_8x8/pe_accum_count
*/
import pkg_systolic::*;

module tb_system_top_8x8;

    timeunit 1ps;
    timeprecision 1ps;

    // Parámetros
    localparam int K        = 8;    // productos por celda
